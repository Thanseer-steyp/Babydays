...
import categoriesData from "@/data/categories.json"; // create this if not exists
      ...
      <header className="header-root w-full bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="hidden sm:flex flex-col items-center gap-0.5 text-gray-500 hover:text-teal-500 transition-colors">
              <UserIcon />
        ...
        {/* ── Mobile drawer ── */}
        <div
          className={`sm:hidden absolute top-full left-0 w-full bg-gray-50 z-40 overflow-hidden transition-all duration-200 ease-in-out transform shadow-lg ${
            mobileOpen
              ? "max-h-[1000px] opacity-100 translate-y-0"
              : "max-h-0 opacity-0 -translate-y-2 pointer-events-none"
          }`}
        >
          <div className="bg-gray-100 border-b border-gray-300  rounded-b-xl shadow-2xl">
            ...
            <div className="px-4 pb-4 grid grid-cols-3 gap-3">
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`flex items-center gap-2 bg-gray-50 px-3 py-2.5 text-sm font-bold rounded-lg transition-colors ${
                    link.hot
