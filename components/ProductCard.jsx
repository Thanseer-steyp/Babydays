...
export default function ProductCard({ product }) {
  ...
  const mainImage = product?.main_media || "/images/fallback.png";

  const price = Number(product?.lowest_variant_price ?? product?.price ?? 0);

  const mrp = Number(product?.lowest_variant_mrp ?? product?.mrp ?? price);
