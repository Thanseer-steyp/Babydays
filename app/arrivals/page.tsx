...
function ProductCard({ product, index }) {
  // ✅ Convert safely (important)
  const price = Number(product.lowest_variant_price ?? product.price);
  const mrp = Number(product.lowest_variant_mrp ?? product.mrp);
    ...
    >
      ...
      <div className="relative w-full h-64 md:h-[400px] overflow-hidden select-none flex items-center justify-center">
        <div className="absolute inset-0">
          <img
            src="/images/arrivals/arrivals.png"
            alt="new arrival"
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-4 text-gray-400">
            ...
            <button
              ...
              className="bg-teal-500 text-white text-sm font-bold px-5 py-2 rounded-lg hover:bg-teal-600 transition-colors"
            >
              Try again
            </button>
          </div>
